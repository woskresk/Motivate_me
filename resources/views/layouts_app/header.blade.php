...
<head>
    ...
    <title>{{ $choice_one->title ?? 'Мотивация В Парах | Реальная Мотивация' }}</title>
    <meta name="description" content="{{ $choice_one->descrip ?? 'Попробуйте взаимную мотивацию в прах БЕСПЛАТНО! Новый сервис для подбора пары взаимной мотивации -\'Motivate_Me\'' }}">
    ...
    <link href="{{ URL::asset('css/slicknav.css') }}" rel="stylesheet">
    <!-- <link rel="stylesheet" href="css/slicknav.css"> --><!-- Этот css отрисовывает мобильное меню -->
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-3 col-lg-3">
                            <div class="logo">
                                <a href="/">
                                    <img src="{{ URL::asset('img/logo.png') }}" alt="" style="height: 70px;" class="wibro">
